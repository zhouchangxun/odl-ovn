 ...
 */
package org.opendaylight.ovn.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import org.opendaylight.ovn.cli.api.OvnCliCommands;
...
public class OvnCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(OvnCliTestCommand.class);
    protected final OvnCliCommands service;

    public OvnCliTestCommand(final OvnCliCommands service) {
